 ...
 * @date 6/6/2023
 */
public class LoserMenu extends Menu {

    private CoinFlip coinFlip;

    public LoserMenu(CoinFlip coinFlip){
    ...
    public String getTitle(Player player) {
        return CC.translate("&a&lCoinflip &7- &c&lYOU LOST!!");
    }
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        for (int i=0; i<27; i++) {
            if (i == 3 || i == 4 || i == 5 || i == 12 || i == 14 || i == 21 || i == 22 || i == 23){
                buttonHashMap.put(i, Button.placeholder(Material.STAINED_GLASS_PANE, (byte) 14, " "));
            }
        }
