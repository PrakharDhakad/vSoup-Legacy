...
public final class ReflectionUtils {
	 ...
	 * @throws IllegalArgumentException If the helper of the value does not match the helper of the desired field
	 * @throws IllegalAccessException If the desired field cannot be accessed
	 * @throws NoSuchFieldException If the desired field of the target class cannot be found
	 * @throws SecurityException If the desired field cannot be made accessible
	 * @see #getField(Class, boolean, String)
	...
	public enum PackageType {
		...
		/**
		 * Construct a new package helper
		 *
		...
		/**
		 * Returns the path of this package helper
		 *
		 * @return The path
		 */
	...
	public enum DataType {
		...
		/**
		 * Construct a new data helper
		 *
		 * @param primitive Primitive class of this data helper
		 * @param reference Reference class of this data helper
		 */
		...
		/**
		 * Returns the primitive class of this data helper
		 *
		...
		/**
		 * Returns the reference class of this data helper
		 *
		...
		/**
		 * Returns the data helper with the given primitive/reference class
		 *
		 * @param clazz Primitive/Reference class of the data helper
		...
		/**
		 * Returns the primitive class of the data helper with the given reference class
		 *
		 * @param clazz Reference class of the data helper
		 * @return The primitive class
		 */
		...
		/**
		 * Returns the reference class of the data helper with the given primitive class
		 *
		 * @param clazz Primitive class of the data helper
		 * @return The reference class
		 */
