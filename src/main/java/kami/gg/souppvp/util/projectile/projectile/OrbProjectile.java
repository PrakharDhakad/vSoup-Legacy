 ...
 *  net.minecraft.server.v1_8_R1.EntityExperienceOrb
...
public class OrbProjectile extends EntityExperienceOrb implements CustomProjectile<OrbProjectile>, IProjectile {
    ...
    private final List<TypedRunnable<OrbProjectile>> typedRunnables = new ArrayList<TypedRunnable<OrbProjectile>>();
    private int age;
    ...
    public OrbProjectile(String name, Location loc, LivingEntity shooter, float power) {
        super((World)((CraftWorld)loc.getWorld()).getHandle(), loc.getX(), loc.getY(), loc.getZ(), 0);
